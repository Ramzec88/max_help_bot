...
- Если вопрос про покупку/доступ — каждый вариант должен содержать ПОЛНЫЙ ответ с обеими ссылками. Не дели одну инструкцию на несколько вариантов.
- Варианты отличаются стилем подачи (короче/подробнее/другим акцентом), но каждый самодостаточен.
- НИКОГДА не ставь знаки препинания (точку, запятую и т.д.) сразу после URL — пиши ссылку отдельно или переноси текст на новую строку.
