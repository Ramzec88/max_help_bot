...
module.exports = {
  ...
  // Projects served by this bot — extend here when a new project's materials are ready
  PROJECTS: [
    { id: 'mishka_max', label: '🧸 Мишка Макс' },
    { id: 'kolyanchik', label: '🎈 Колянчик' },
  ],
  BOT_DESCRIPTION:
    '🐻 Бот поддержки детских проектов «Мишка Макс» и «Колянчик». ' +
